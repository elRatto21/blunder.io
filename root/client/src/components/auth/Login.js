                ...
                <form className="mt-8 space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="text-sm">
                            <a href="forgot" className="font-medium text-blue-600 hover:text-blue-500 dark:text-gray-300 dark:hover:text-gray-100">
                                Forgot your password?
                            </a>
                        </div>
                        <div className="text-sm">
                            <a href="register" className="font-medium text-blue-600 hover:text-blue-500 dark:text-gray-300 dark:hover:text-gray-100">
                                Register an account
                            </a>
                        </div>
                    </div>
